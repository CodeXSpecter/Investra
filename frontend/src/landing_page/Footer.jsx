  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col text-start footer-links">
          <p>Account</p>
      ...
      <div className="mt-5 text-small text-muted text-start smallprint" style={{fontSize:"12px"}}>
      <p>
      ...
      <div className="d-flex flex-wrap gap-3 text-center justify-content-center footer-links">
        <a href="#">NSE</a>
        <a href="#">BSE</a>
        <a href="#">MCX</a>
